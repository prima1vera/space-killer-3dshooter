...
public class DeveloperConsole : MonoBehaviour
{
    ...
    {
        outputText.text = "Developer Console\n\nClass: CAS 117 Summer 2025\nUnity Engine: "+Application.unityVersion+"\nProduct Name: "+Application.productName+"\nVersion: "+Application.version+"\nCompany Name: "+Application.companyName+"\n\nThis is the Developer Console meant for use by Course Admins.\n\nIf you are not a TA or instructor you can put in commands if you want, " +

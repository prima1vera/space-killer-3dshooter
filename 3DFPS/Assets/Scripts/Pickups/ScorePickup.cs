...
public class ScorePickup : Pickup
{
    ...
    {
        if (collision.tag == "Player" && GameManager.instance != null && collision.gameObject.GetComponent<Health>() != null && collision.gameObject.GetComponent<Health>().currentHealth > 0)
        {
